...
Public Class FrmRptSalesRetPara

    Dim sel As Integer

    Private Sub FrmRptSalesRetPara_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Cal.Hide()
    ...
    Private Sub BtnCreate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCreate.Click
        ...
        Else
            ...
            Try
                ...
                MyCommand.CommandText = "SELECT * FROM sales_ret where sale_ret_date > '" & CDate(TxtstDate.Text) & "' and sale_ret_date < '" & CDate(TxtEndDate.Text) & "';"
