...
Public Class FrmRptUserDetailPara
    ...
    Private Sub BtnCreate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCreate.Click
        ...
        Else
            ...
            Try
                ...
                MyCommand.CommandText = "SELECT * FROM login_detail where logindate >'" & CDate(TxtstDate.Text) & "' and logindate <'" & CDate(TxtEndDate.Text) & "';"
