...
Public Class FrmRptSalesPara

    Dim sel As Integer

    Private Sub FrmRptSalesPara_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Cal.Hide()
    ...
    Private Sub BtnCreate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCreate.Click
        ...
        Else
            ...
            Try
                ...
                MyCommand.CommandText = "SELECT * FROM sales where sale_date > '" & CDate(TxtstDate.Text) & "' and sale_date < '" & CDate(TxtEndDate.Text) & "';"
