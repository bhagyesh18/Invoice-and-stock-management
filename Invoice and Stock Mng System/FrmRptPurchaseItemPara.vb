...
Public Class FrmRptPurchaseItemPara

    Dim sel As Integer

    Private Sub FrmRptPurchaseItemPara_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Cal.Hide()
    ...
    Private Sub BtnCreate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCreate.Click
        ...
        Else
            ...
            Try
                ...
                MyCommand.CommandText = "SELECT * FROM purchase where pur_date > '" & CDate(TxtstDate.Text) & "' and pur_date < '" & CDate(TxtEndDate.Text) & "';"
